...
public:
    inline UnconfirmedName(const std::shared_ptr<Scope> & _specifiedScope, const std::vector<std::shared_ptr<Scope>> & _currentScopeStack, const std::vector<std::shared_ptr<Scope>> & _usingScopes, const std::string & _baseName) : __currentScopeStack(_currentScopeStack), __specifiedScope(_specifiedScope), __usingScopes(_usingScopes), __baseName(_baseName) {}
